...
export default function Footer() {
    return (
        <footer className="mx-4 md:mx-8 lg:mx-12 mb-4 md:mb-8 lg:mb-12 bg-white/80 backdrop-blur-xl py-4 md:py-6 lg:py-8 rounded-full border-2 border-gray-900/10 shadow-[0_20px_40px_rgba(0,0,0,0.1)]">
            <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-12">
                <div className="flex flex-col lg:flex-row justify-between items-center gap-3 md:gap-4 lg:gap-0">
                    <div className="flex-1 text-center lg:text-left flex flex-col md:flex-row items-center gap-2 md:gap-4">
                        <p className="text-gray-600 text-xs md:text-sm font-bold">
                            © {new Date().getFullYear()} Pumpkin 🎃.
                        </p>
                    ...
                    {/* Center: Founder Info */}
                    <div className="flex-1 text-center order-first lg:order-none w-full lg:w-auto">
                    ...
                    <div className="flex-1 flex flex-col sm:flex-row items-center justify-center lg:justify-end gap-2 sm:gap-4 md:gap-6">
                        {/* Tech Stack Icons */}
                        <div className="flex items-center gap-2 md:gap-3 opacity-60 hover:opacity-100 transition-opacity">
                            {/* JavaScript Logo */}
                            <svg viewBox="0 0 100 100" className="w-4 h-4 md:w-6 md:h-6 rounded-sm fill-[#F7DF1E]" role="img" aria-label="JavaScript">
                            ...
                            {/* TypeScript Logo */}
                            <svg viewBox="0 0 100 100" className="w-4 h-4 md:w-6 md:h-6 rounded-sm fill-[#3178C6]" role="img" aria-label="TypeScript">
                                <title>TypeScript</title>
                                <rect width="100" height="100" rx="10" ry="10" />
                                <text x="75" y="75" fontSize="45" fontWeight="bold" fill="white" textAnchor="middle" fontFamily="Arial, sans-serif">TS</text>
                            </svg>
                            {/* Next.js Logo */}
                            <svg viewBox="0 0 180 180" className="w-4 h-4 md:w-6 md:h-6 fill-black" role="img" aria-label="Next.js">
                                <title>Next.js</title>
                                <mask height="180" id="mask0_408_134" maskUnits="userSpaceOnUse" width="180" x="0" y="0" style={{ maskType: 'alpha' }} ><circle cx="90" cy="90" fill="#000" r="90" /></mask>
                                <g mask="url(#mask0_408_134)"><circle cx="90" cy="90" data-circle="true" fill="#000" r="90" /><path d="M149.508 157.52L69.142 54H54v71.97h12.27V66.912l80.284 103.235c2.492-6.582 5.067-12.637 2.954-12.627z" fill="#fff" /><path d="M115.79 54h12.27v72h-12.27z" fill="#fff" /></g>
                            </svg>
                            {/* Node.js Logo (Simple Hexagon) */}
                            <svg viewBox="0 0 32 32" className="w-4 h-4 md:w-6 md:h-6 fill-[#339933]" role="img" aria-label="Node.js">
                                <title>Node.js</title>
                            ...
                            {/* Rust Logo (Simple Gear) */}
                            <svg viewBox="0 0 100 100" className="w-4 h-4 md:w-6 md:h-6 fill-[#000000]" role="img" aria-label="Rust">
                                <title>Rust</title>
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="text-gray-600 hover:text-pumpkin-orange transition-all transform hover:scale-110 p-1.5 md:p-2 rounded-full border-2 border-transparent hover:border-pumpkin-orange"
