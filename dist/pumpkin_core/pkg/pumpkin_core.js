...
const PumpkinVMFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_pumpkinvm_free(ptr >>> 0, 1));

class PumpkinVM {
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        PumpkinVMFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_pumpkinvm_free(ptr, 0);
    }
    constructor() {
        const ret = wasm.pumpkinvm_new();
        this.__wbg_ptr = ret >>> 0;
        PumpkinVMFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
    ...
    run(ast_json) {
        ...
        const ret = wasm.pumpkinvm_run(this.__wbg_ptr, ptr0, len0);
        return ret;
    }
}
if (Symbol.dispose) PumpkinVM.prototype[Symbol.dispose] = PumpkinVM.prototype.free;
exports.PumpkinVM = PumpkinVM;
...
const wasmPath = `${__dirname}/pumpkin_core_bg.wasm`;
